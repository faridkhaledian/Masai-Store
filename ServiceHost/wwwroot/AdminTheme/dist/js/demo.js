...
$(document).ready(function () {
    ...
    $('.sidebar-menu a').each(function () {
        ...
        // فقط اگر لینک واقعی (نه href="#" برای منوی والد)
        if (href && href !== '#' && href === currentPath) {
            ...
            var $treeview = $li.parents('.treeview');
            $treeview.addClass('menu-open');
            $treeview.children('a').addClass('active');
            $treeview.children('.treeview-menu').css('display', 'block');
        }
    });

    if (!matched) {
        $('.sidebar-menu li.dashboard-default').addClass('active');
    }
});